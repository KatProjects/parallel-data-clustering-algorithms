...
void clusterDistribution(float** data, float** centers, int size_mass, float** distances, int* cluster_indexes) {
...
void k_means(float** data, int size_mass, int* cluster_indexes, float** centers, float** oldCenters, float** distances) {
    ...
    while (iteration < max_iterations) {
        ...
        clusterDistribution(data, centers, size_mass, distances, cluster_indexes);
...
int main() {
    ...
    for (int i = 0; i < numIterations; i++) {
        ...
        k_means(myArray1, size_mass1, cluster_indexes1, centers1, oldCenters1, distances1);
    ...
    for (int i = 0; i < numIterations; i++) {
        ...
        k_means(myArray2, size_mass2, cluster_indexes2, centers2, oldCenters2, distances2);
    ...
    for (int i = 0; i < numIterations; i++) {
        ...
        k_means(myArray3, size_mass3, cluster_indexes3, centers3, oldCenters3, distances3);
    ...
    cout << "K-means algorithm with OpenMP. Program running time averaged over " << numIterations << " iterations." << endl << endl;

    cout << "CPU C++ Omp (10000,3): " << average_duration1 << " ms." << endl;
    cout << "CPU C++ Omp (100000,3): " << average_duration2 << " ms." << endl;
    cout << "CPU C++ Omp (1000000,3): " << average_duration3 << " ms." << endl;
