...
int main() {
  ...
  //  }
    ...
    //cout << "DBSCAN algorithm. Start of program timing." << endl << endl;
    ...
    cout << "DBSCAN algorithm. Program running time averaged over " << "1 iterations." << endl << endl;

    cout << "CPU C++ (10000,3): " << duration1 << " ms." << endl;
    //cout << "CPU C++ (100000,3): " << duration2 << " ms." << endl;
   // cout << "CPU C++ (1000000,3): " << duration3 << " ms." << endl;
